          ...
          <div className="col-lg-4">
            <div className="footer-brand">
              ...
              <div className="social-links">
                <a href="https://www.linkedin.com/company/hub-c-oficial/" className="text-icon-accent me-3" aria-label="LinkedIn">
                ...
                <a href="https://www.instagram.com/hubc.oficial/" className="text-icon-accent" aria-label="Instagram">
                  <svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
